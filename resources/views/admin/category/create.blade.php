        ...
        <div class="col-md-8">
            ...
            <ul class="list-group mt-5">
                @foreach($sub_cats as $sub_cat)
                    <li class="list-group-item">
                        <a href="/admin/subcategory/all">{{$sub_cat->name}}</a>
                        <span class="float-right">
                            <i class="fa fa-edit text-warning pl-2" id="edit_cat" onclick="subCatEdit('{{$sub_cat->name}}','{{$sub_cat->id}}')"></i>
                            <a href="/admin/subcategory/{{$sub_cat->id}}/delete"> 
                                <i class="fa fa-trash text-danger pl-2"></i>
                            </a>
                        </span>
                    </li>
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <input type="hidden" id="sub_cat_edit_token" name="token" value="{{\App\Classes\CSRFToken::_token()}}">
